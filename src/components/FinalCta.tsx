...
export function FinalCta({
  ...
  return (
    <section
      className={cx(
        "FinalCta relative isolate overflow-hidden px-6 py-24 md:px-10 lg:px-20 lg:py-40",
    ...
    >
      ...
      <div
        ...
        className={cx(
          ...
          variant === "dark" ? "bg-g5/90" : "bg-g5/25",
        )}
      />
      {variant === "photo" ? (
        <div className="FinalCtaPanel mx-auto max-w-section rounded-2xl bg-g5/50 px-6 py-16 shadow-theme-sm backdrop-blur-[10px] md:p-20">
          {copy}
        </div>
      ) : (
        copy
